...
@interface AppleHardwareAACEncoder()
@property (nonatomic, assign) AudioConverterRef converterRef;
@end

@implementation AppleHardwareAACEncoder
...
- (void)private_setupAudioConvert{
    ...
    inputFormat.mSampleRate = 8000;//采样率
...
//    inputFormat.mFormatFlags = kLinearPCMFormatFlagIsSignedInteger | kLinearPCMFormatFlagIsPacked;
    inputFormat.mChannelsPerFrame = 1;//每帧声道数
    ...
    [AppleHardwareAACEncoder printAudioStreamBasicDescription:inputFormat];
    ...
    [AppleHardwareAACEncoder printAudioStreamBasicDescription:outputFormat];
...
//        },
    ...
    //4.编码器
    OSStatus result = AudioConverterNewSpecific(&inputFormat, &outputFormat, outputFormat.mChannelsPerFrame, requestedCodecs, &_converterRef);
